...
const { seasonFindFirstMock, selectMock, requireSeasonAdminMock, notFoundMock, redirectMock } = vi.hoisted(() => ({
...
vi.mock("@/actions/discipline", () => ({
  getSeasonSanctions: vi.fn(async (seasonId: string) => ({
...
describe("admin discipline page", () => {
  beforeEach(() => {
    ...
    // 第一个 select：处罚 subjects 的用户名；第二个 select：赛季报名用户候选
