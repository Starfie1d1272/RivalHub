...
ALTER TABLE "competition_entries" DROP CONSTRAINT "competition_entries_current_roster_revision_scope_fk";
--> statement-breakpoint
ALTER TABLE "competition_entries" DROP CONSTRAINT "competition_entries_approved_roster_revision_scope_fk";
--> statement-breakpoint
