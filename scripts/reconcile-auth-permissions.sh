...
git rm -f reconcile-auth-conflicts.txt reconcile-auth-diagnostic.txt .github/workflows/reconcile-auth-permissions.yml scripts/reconcile-auth-permissions.sh
git add -A
