...
| Demo 比赛页展现 | `src/components/matches/DemoPlayerStatsTable.tsx`、`src/components/matches/DemoHeatmap.tsx`、`src/components/matches/DemoRoundTimeline.tsx`、`src/components/matches/DemoKillFeed.tsx`、`src/components/matches/DemoEconomyChart.tsx`、`src/components/matches/DemoClutchList.tsx` | `src/lib/demo/map-calibration.ts` |
