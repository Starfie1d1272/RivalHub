...
export default async function RulesPage() {
  const rulebook = await readFile(resolve(process.cwd(), "docs/rules/nju-major.md"), "utf8");
  return <div className="mx-auto max-w-4xl space-y-5 px-4 py-12">
    ...
    <pre className="whitespace-pre-wrap break-words rounded-sm border border-[var(--color-border)] bg-[var(--color-panel)] p-5 font-sans text-sm leading-7 text-[var(--color-fg)]">{rulebook}</pre>
