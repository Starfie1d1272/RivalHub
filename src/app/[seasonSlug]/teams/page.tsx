...
export default async function CompetitionEntriesPage({ params }: { params: Promise<{ seasonSlug: string }> }) {
  ...
  return <div className="container mx-auto max-w-6xl space-y-8 px-4 py-12">
    <div className="flex items-center justify-between"><Marker sub={season.name}>赛事队伍</Marker><Suspense fallback={null}><AdminShortcutSlot href={`/admin/${seasonSlug}/settings`} label="赛事管理" /></Suspense></div>
