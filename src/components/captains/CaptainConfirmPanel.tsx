        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription className="space-y-3 pt-2">
              ...
              <div className="rounded-md border p-3 text-sm" style={{ borderColor: "color-mix(in srgb, var(--color-warn) 40%, transparent)", background: "color-mix(in srgb, var(--color-warn) 8%, transparent)" }}>
