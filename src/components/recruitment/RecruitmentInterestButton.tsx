...
export function RecruitmentInterestButton({ recruitmentIntentId, interested, loggedIn, loginHref = "/login?next=/teams/recruitment" }: { recruitmentIntentId: string; interested: boolean; loggedIn: boolean; loginHref?: string }) {
