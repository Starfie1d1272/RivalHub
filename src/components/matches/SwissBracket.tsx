      ...
      <div
        className={`text-xs font-medium mb-1.5 px-1.5 py-0.5 rounded text-center ${
          isEliminatedRecord(group.record)
            ? "bg-[color-mix(in srgb, var(--color-danger) 8%, transparent)] text-[var(--color-danger)]"
            : isAdvancedRecord(group.record)
              ? "bg-[color-mix(in srgb, var(--color-ok) 10%, transparent)] text-[var(--color-ok)]"
...
function AdvancementColumn({
  ...
  return (
    <div className="flex-1 min-w-[140px] max-w-[180px] space-y-4">
      ...
      {advanced.length > 0 && (
        <div>
          <div className="text-xs font-medium mb-1.5 px-1.5 py-0.5 rounded text-center bg-[color-mix(in srgb, var(--color-ok) 10%, transparent)] text-[var(--color-ok)]">
      ...
      {eliminated.length > 0 && (
        <div>
          <div className="text-xs font-medium mb-1.5 px-1.5 py-0.5 rounded text-center bg-[color-mix(in srgb, var(--color-danger) 8%, transparent)] text-[var(--color-danger)]">
