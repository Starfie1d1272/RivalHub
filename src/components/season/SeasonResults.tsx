...
export function SeasonResults({ results, slug, compact = false }: { results: PublicSeasonResults; slug: string; compact?: boolean }) {
  return <Panel label="赛事结果" contentClassName="space-y-4 p-5">
