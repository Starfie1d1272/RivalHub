...
const CURRENT_PRODUCER_ACTIONS = [
  ...
  "match.managed.invalidated", "competition_qualification.invalidate_match", "match.recovery.adjudicated",
  ...
  "major_prestart.set_managed_profile", "competition_qualification.configure", "competition_qualification.rank",
  "competition_qualification.generate_round", "competition_qualification.reset", "competition_qualification.sync_roster",
  "competition_qualification.reconcile_roster",
  "competition_qualification.invalidate_match",
