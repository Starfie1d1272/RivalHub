...
export const AUDIT_ACTION_DEFINITIONS = {
  ...
  "competition_qualification.sync_roster": { label: "同步 Play-in 参赛名单", category: "major" },
  "competition_qualification.reconcile_roster": { label: "同步 Play-in 报名名单", category: "major" },
