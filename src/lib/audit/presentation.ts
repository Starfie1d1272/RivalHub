...
const TARGET_OVERRIDES: Readonly<Partial<Record<AuditAction, AuditTargetContract>>> = {
  ...
  "match.demo.reject": { type: "match_demo_import", lifecycle: "tombstone" },
  "match.demo.identity_retire": { type: "user_gameplay_steam_id", lifecycle: "tombstone" },
...
export const AUDIT_ACTION_DEFINITIONS = {
  ...
  "match.demo.recheck": { label: "重新确认 Demo 数据", category: "match" },
  ...
  "major_prestart.select_entrants": { label: "选择并同步 Major 参赛队", category: "major" },
  "major_prestart.reconcile_roster": { label: "同步 Major 报名名单", category: "major" },
  "major_prestart.repair_roster": { label: "补正 Major 参赛名单", category: "major" },
...
const TARGET_TYPE_LABELS: Readonly<Record<string, string>> = {
  ...
  user_gameplay_steam_id: "比赛 Steam 身份",
  match_roster: "比赛阵容",
