...
export const STATS_METRICS = {
  ...
  killRoundRate: metric("Kill Round%", "ratioPercent", 1, "rounds", "至少取得一次击杀的回合占全部出场回合的比例。", { rankingSampleKind: "rounds" }),
  threePlusKillRoundRate: metric("3K+ Round%", "ratioPercent", 1, "rounds", "取得至少三杀的回合占全部出场回合的比例，用于补充观察高爆发回合。", { rankingSampleKind: "rounds" }),
  ...
  damagePerKill: metric("Damage/Kill", "number", 1, "kills", "总伤害 ÷ 总击杀，用于观察每次击杀背后的平均伤害投入。", { rankingSampleKind: "kills" }),
  ...
  sniperKillsPerRound: metric("Sniper Kills/100r", "per100Round", 1, "rounds", "每 100 回合通过 AWP 或 SSG 08 取得的击杀数。", { rankingSampleKind: "rounds" }),
  awpKillShare: metric("AWP Kill Share", "ratioPercent", 1, "weaponKills", "AWP 击杀占本人全部武器击杀的比例。", { rankingSampleKind: "weaponKills" }),
  awpKillsPerRound: metric("AWP Kills/100r", "per100Round", 1, "rounds", "每 100 回合通过 AWP 取得的击杀数。", { rankingSampleKind: "rounds" }),
