...
export const STATS_METRICS = {
  ...
  mk: metric("MK/100r", "per100Round", 2, "scoreboard", "每 100 回合多杀回合数。", { rankingSampleKind: "rounds" }),
  openingAttempt: metric("Open Att%", "ratioPercent", 1, "rounds", "参与首杀对枪的回合占比，反映开局交火参与频率。", { rankingSampleKind: "rounds" }),
  openingWin: metric("Open Win%", "ratioPercent", 1, "openings", "首杀对枪胜率：首杀次数 ÷ 首杀对枪次数。", { rankingSampleKind: "openings" }),
  ...
  pistol: metric("Pistol%", "ratioPercent", 1, "pistolRounds", "手枪局胜率。", { rankingSampleKind: "pistolRounds" }),
  ...
  ecoSemi: metric("Eco/Semi", "ratioPercent", 1, "opportunities", "低经济方对高经济方的回合胜率。", { rankingSampleKind: "opportunities" }),
