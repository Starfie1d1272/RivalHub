...
export const STATS_METRICS = {
  ...
  break: metric("R2 Break", "percent", 1, "opportunities", "手枪局失利后赢下第二回合的比例。", { rankingSampleKind: "opportunities" }),
  fiveVFour: metric("5v4", "percent", 1, "opportunities", "进入 5v4 人数优势后赢下该回合的比例。", { rankingSampleKind: "opportunities" }),
  fourVFive: metric("4v5", "percent", 1, "opportunities", "进入 4v5 人数劣势后赢下该回合的比例。", { rankingSampleKind: "opportunities" }),
  ecoSemi: metric("Eco/Semi", "percent", 1, "opportunities", "低经济方对高经济方的回合胜率。", { rankingSampleKind: "opportunities" }),
  plantConversion: metric("Plant conv", "percent", 1, "plants", "完成下包后的回合胜率。", { rankingSampleKind: "plants" }),
  headshot: metric("HS%", "percent", 1, "kills", "爆头击杀占全部击杀的比例。", { rankingSampleKind: "kills" }),
  killShare: metric("Kill share", "percent", 1, "weaponKills", "该武器击杀占当前范围全部武器击杀的比例。", { rankingSampleKind: "weaponKills" }),
  killsPerRound: metric("Kills/R", "perRound", 2, "rounds", "平均每回合击杀数。", { rankingSampleKind: "rounds" }),
  damagePerRound: metric("DMG/R", "perRound", 1, "rounds", "平均每回合伤害。", { rankingSampleKind: "rounds" }),
